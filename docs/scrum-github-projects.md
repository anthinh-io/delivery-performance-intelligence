# Cẩm nang: Scrum with GitHub Projects
...
## 4. ⚠️ Cạm bẫy: Sub-issue "biến mất" khỏi view Sprint
...
Mở view **Current Iteration**, tự hỏi: *đang thế nào? có đạt kế hoạch không? có gì cản trở?*
