...
| 4 | 6/8 – 12/8 | Xây dựng Dashboard KPI tổng quan: 5 KPI cốt lõi (tỷ lệ đúng hạn, số đơn trễ, thời gian xử lý người bán, thời gian vận chuyển, tỷ lệ đánh giá thấp liên quan trễ) + biểu đồ xu hướng theo thời gian + biểu đồ tỷ lệ trễ theo vùng, kèm bộ lọc thời gian/khu vực | Người quản lý xem được hiệu suất giao hàng trực quan, thay thế theo dõi thủ công |
