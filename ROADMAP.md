...
| 3 | 30/7 – 5/8 | Thử đặc trưng khoảng cách người bán↔khách hàng, tinh chỉnh hyperparameter, đóng gói mô hình | Xác nhận trần chất lượng mô hình thật (~0.35) qua thí nghiệm đặc trưng khoảng cách và điều chỉnh trọng số lớp — mục tiêu chất lượng đàm phán lại còn F1≥0.30 (Story #10), mở đường xây API |
